      ...
      <Dialog open={open} onOpenChange={setOpen}>
        ...
        <DialogContent className="min-w-[600px] max-h-[650px] overflow-auto">
          <DialogHeader>
            ...
            <DialogDescription>
              Make changes to your work experiences here. Click save when you're done.
            </DialogDescription>
          </DialogHeader>
          ...
          <Formik
            ...
            onSubmit={async values => {
              if (!isLoading && id) {
                try {
                  await updateProjects({ workExperiences: values.workExperiences, id }).unwrap();
                  toast({
                    title: 'Successful!',
                    description: 'Work experiences have been updated.',
